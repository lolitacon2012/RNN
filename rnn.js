...
function Model(){
	...
	this.sgd_step = (x, y, learning_rate) => {
		...
		this.U = math.add(this.U, 0 - learning_rate * dU)
    	this.V = math.add(this.V, 0 - learning_rate * dV)
    	this.W = math.add(this.W, 0 - learning_rate * dW)
	}
...
rnn.train(X_train,Y_train,0.05,2,1);
